      ...
      >
        {restaurants.map((rest, idx) => (
          <div
            ...
            style={{ marginLeft: idx === 0 ? "24px" : undefined }}
          ...
          >
            ...
            <div className="mt-2.5">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">{"฿".repeat(rest.priceLevel)} · {rest.address}</p>
            </div>
          </div>
        ))}
        <div style={{ minWidth: "10px", flexShrink: 0 }} aria-hidden="true" />
      </div>
    </div>
  );
}
