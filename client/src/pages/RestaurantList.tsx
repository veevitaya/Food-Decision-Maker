        ...
        {isBars ? (
          <>
            ...
            <div className="flex-1 relative h-7">
              <span
                aria-label="Drunk Toast mascot"
                role="img"
                className="h-[72px] w-[72px] absolute animate-drunk-stumble gpu-accelerated drop-shadow-sm text-2xl leading-[72px] text-center"
                style={{ bottom: -6 }}
      ...
      {isLoading ? (
        ...
        <div className="px-6 py-5 space-y-4">
          {restaurants.map((r, idx) => (
            ...
            >
              {r.source && (
                <div className="absolute -top-2 left-4 bg-gray-100 rounded-full px-2.5 py-0.5 text-[9px] font-bold uppercase tracking-wider text-foreground z-10">
                  {r.source}
                </div>
              )}
              ...
              <div className="flex-1 min-w-0 py-2 pr-2">
                ...
                <div className="flex items-center gap-2 mt-2.5 text-xs text-muted-foreground">
                  ...
                  <span>|</span>
                  <span className="truncate">Addr: {r.address}</span>
                </div>
                {r.description && (
